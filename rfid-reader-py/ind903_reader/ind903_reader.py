...
class Ind903Reader(reader.Reader):
    ...
    def doInventory(self, processEPCCallback, antenna=b'\x01'):
        """
        ...
        :param processEPCCallback(epcID): callback function to process a EPC found during inventory.
